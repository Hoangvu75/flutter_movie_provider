...
MovieDetailsResponse movieDetailResponseFromJson(String str) => MovieDetailsResponse.fromJson(json.decode(str));

String movieDetailResponseToJson(MovieDetailsResponse data) => json.encode(data.toJson());
