  ...
  Widget build(BuildContext context) {
    return ScaleTap(
      onPressed: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => MovieDetailsScreen(id: widget.movie.id!)),
        );
      },
      child: Padding(
        padding: EdgeInsets.fromLTRB(16 * responsiveSize.width, 10 * responsiveSize.width,
            16 * responsiveSize.width, 10 * responsiveSize.width),
        child: Container(
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                SizedBox(width: 4 * responsiveSize.width),
                Expanded(
                  child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(4 * responsiveSize.width),
